...
import 'package:gd_modul_bloc_1353/bloc/login_event.dart';
import 'package:gd_modul_bloc_1353/bloc/login_state.dart';
import 'package:gd_modul_bloc_1353/repository/login_repository.dart';
...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  void _onIsPasswordVisibleChanged(
    ...
    emit(state.copyWith(
      ...
      formSubmissionState: const InitialFormSubmissionState(),
    ));
  }
